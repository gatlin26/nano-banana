...
export default function Hero() {
  return (
              <section className="pt-16 pb-20 bg-gradient-to-br from-blue-50 via-white to-blue-100" itemScope itemType="https://schema.org/SoftwareApplication">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          >
            <span className="text-blue-600">Nano Banana</span> AI Image Generator<br />
          ...
          >
            ...
            <a href="#showcase">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button size="lg" variant="outline" className="border-2 border-gray-200 text-gray-700 hover:border-blue-300 hover:text-blue-600">
